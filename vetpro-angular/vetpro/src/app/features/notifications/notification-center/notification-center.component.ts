      ...
      <div class="page-header">
        <div class="header-titles">
          ...
          <p class="page-subtitle">
            Monitorea y gestiona el envío de recordatorios automáticos y campañas de fidelización.
          </p>
        </div>
            ...
            <tbody>
              @for (notif of filteredNotifications(); track notif) {
                <tr>
                  ...
                  <td>
                    <span class="snippet" [title]="notif.messageSnippet">{{
  ...
  formatTrigger(trigger: string): string {
    switch (trigger) {
      ...
      case 'appointment_reminder_2h':
        return 'Aviso 2h antes';
      case 'vaccine_due':
        return 'Vacuna por vencer';
      case 'invoice_receipt':
        return 'Recibo de Factura';
      case 'marketing_reactivation':
        return 'Reactivación Inactivos';
      default:
        return trigger;
    }
  }
