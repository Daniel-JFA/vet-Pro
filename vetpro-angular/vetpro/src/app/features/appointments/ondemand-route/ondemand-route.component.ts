  ...
  template: `
    <div class="ondemand-container">
      ...
      <div class="route-header">
        <div class="header-main">
          ...
          <p class="header-subtitle">
            Gestión de consultas a domicilio, navegación GPS, cobro digital y maletín móvil.
          </p>
        </div>
      ...
      <div class="visits-feed">
        @for (visit of appointments(); track visit; let i = $index) {
          <div
            class="visit-card"
            [class.active-card]="
              visit.trackingStatus === 'on_the_way' ||
              visit.trackingStatus === 'arrived' ||
              visit.trackingStatus === 'in_progress'
            "
          ...
          >
            ...
            <div class="patient-info-row">
              ...
              <div class="pet-details">
                <h3 class="pet-name">
                  {{ visit.patientName }} <span class="breed">({{ visit.patientBreed }})</span>
                </h3>
            ...
            <div class="location-box">
              <div class="address-text">
                ...
                <div>
                  ...
                  <span class="city-sub"
                    >{{ visit.city }}
                    @if (visit.notesAddress) {
                      <span>• {{ visit.notesAddress }}</span>
                    }
                  </span>
                </div>
              </div>
              @if (visit.trackingStatus !== 'completed') {
            ...
            <div class="card-actions">
              <!-- Step 1: Start Moving -->
              @if (visit.trackingStatus === 'assigned') {
                <button class="action-btn btn-start" (click)="updateStatus(visit.id, 'on_the_way')">
                  <span class="material-symbols-outlined">two_wheeler</span>
                  Voy en Camino al Domicilio
                </button>
              }
              <!-- Step 2: Arrived -->
              @if (visit.trackingStatus === 'on_the_way') {
                <button class="action-btn btn-arrived" (click)="updateStatus(visit.id, 'arrived')">
                  <span class="material-symbols-outlined">door_front</span>
                  Llegué a la Puerta del Tutor
                </button>
              }
              <!-- Step 3: Start Consultation & Open AI Voice -->
              @if (visit.trackingStatus === 'arrived' || visit.trackingStatus === 'in_progress') {
                <div class="in-consult-actions">
            ...
            @if (activePaymentVisit(); as v) {
              <div class="modal-body">
                ...
                <div class="qr-box">
                  ...
                  <span class="qr-key"
                    >Llave / Celular: <strong>{{ v.tutorPhone }}</strong></span
                  >
                </div>
      ...
      @if (showInventoryModal()) {
        <div class="modal-backdrop" (click)="showInventoryModal.set(false)">
          <div class="modal-card" (click)="$event.stopPropagation()">
            <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="inventory-list">
                @for (item of mobileInventory(); track item) {
...
export class OndemandRouteComponent {
  ...
  mobileInventory = signal<MobileInventoryItem[]>([
    {
      id: 'inv-1',
      name: 'Vacuna Séxtuple Canina (Nobivac)',
      category: 'Biológicos',
      quantity: 5,
      unit: 'dosis',
    },
    ...
    {
      id: 'inv-3',
      name: 'Microchip ISO Identificación',
      category: 'Insumos',
      quantity: 4,
      unit: 'und',
    },
    ...
    {
      id: 'inv-6',
      name: 'Metoclopramida 10mg Ampollas',
      category: 'Fármacos',
      quantity: 4,
      unit: 'amp',
    },
    {
      id: 'inv-7',
      name: 'Meloxicam 0.5% Gotas Orales',
      category: 'Fármacos',
      quantity: 2,
      unit: 'frasco',
    },
  ...
  pendingCount = computed(
    () => this.appointments().filter((a) => a.trackingStatus !== 'completed').length,
  );
  ...
  confirmPaymentReceived(id: string) {
    this.appointments.update((list) =>
      list.map((item) =>
        item.id === id ? { ...item, trackingStatus: 'completed', paymentStatus: 'paid' } : item,
      ),
    );
