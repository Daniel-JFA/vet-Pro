        ...
        <form [formGroup]="form" (ngSubmit)="submit()">
          ...
          <div class="field">
            <label
              >{{
                selectedType() === 'clinic'
                  ? 'Nombre de la Clínica / Centro Veterinario'
                  : 'Nombre Profesional o Marca Comercial'
              }}
              *</label
            >
            <input
              ...
              [placeholder]="
                selectedType() === 'clinic'
                  ? 'Ej. Clínica San Miguel'
                  : 'Ej. Dr. Andrés Flórez - Vet Domicilios'
              "
            />
          </div>
          ...
          <div class="field">
            ...
            <input
              ...
              placeholder="admin@tuveterinaria.com"
          ...
          <div class="row-2">
            ...
            <div class="field">
              ...
              <select
                ...
                [disabled]="!form.value.departamentoCode || loadingMunicipios()"
              >
      ...
      .register({
        ...
        documentType:
          this.selectedType() === 'independent_vet'
            ? (val.documentType as 'CC' | 'CE' | 'TI' | 'PA' | undefined)
            : undefined,
        documentNumber:
          this.selectedType() === 'independent_vet'
